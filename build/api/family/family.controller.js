...
var _family = require("./family.model");
        ...
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return _family.Family.findOne({
              _id: req.params.id
            }).lean().populate('clubs', '-_id -__v').populate('students', '-clubs').exec();
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _context2.prev = 0;
            _context2.next = 3;
            return _family.Family.find(req.query).lean().populate('clubs', '-_id -__v -families').exec();

          case 3:
            families = _context2.sent;
            res.status(200).json({
              data: families
            });
            _context2.next = 11;
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            _context3.prev = 0;
            _context3.next = 3;
            return _family.Family.create(_objectSpread({}, req.body));
      ...
      while (1) {
        switch (_context5.prev = _context5.next) {
          case 0:
            _context5.prev = 0;
            _context5.next = 3;
            return _family.Family.findOneAndRemove({
              _id: req.params.id
            });
